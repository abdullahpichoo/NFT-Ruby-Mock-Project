...
class WalletsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wallet" do
    assert_difference("Wallet.count") do
      post wallets_url, params: { wallet: { balance: @wallet.balance, earnings: @wallet.earnings, items_sold: @wallet.items_sold, user_id: @wallet.user_id } }
    end
  ...
  test "should update wallet" do
    patch wallet_url(@wallet), params: { wallet: { balance: @wallet.balance, earnings: @wallet.earnings, items_sold: @wallet.items_sold, user_id: @wallet.user_id } }
